    ...
    this.each(function() {
      ...
      if (!select.next().hasClass('nice-select')) {
        ...
        options.each(function() {
          ...
          dropdown.find('ul').append('<li class="option ' + ($(this).is(':selected') ? 'selected focus' : '') + 
      ...
      // Down
        ...
        if (!dropdown.hasClass('open')) {
          ...
          if (focused_option.next().length > 0) {
            dropdown.find('.focus').removeClass('focus');
            var element=focused_option.next().addClass('focus');
               dropdown.find('.list').animate({
            scrollTop: element.position().top + dropdown.find('.list').scrollTop()
        }, 'fast');
      ...
      // Up
        ...
        if (!dropdown.hasClass('open')) {
          ...
          if (focused_option.prev().length > 0) {
            dropdown.find('.focus').removeClass('focus');
             var element=focused_option.prev().addClass('focus');
            dropdown.find('.list').animate({
            scrollTop: element.position().top + dropdown.find('.list').scrollTop()
        }, 'fast');    
          }
